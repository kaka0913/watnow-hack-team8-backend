...
func NewGeminiStoryRepository(client *ai.GeminiClient) repository.StoryGenerationRepository {
...
func (g *geminiStoryRepository) generateStoryContent(ctx context.Context, route *model.SuggestedRoute, theme string, realtimeContext *model.RealtimeContext) (*ai.StoryContent, error) {
